...
# 🔥 FNO లో లేని కచ్చితమైన NIFTY SMALLCAP స్టాక్స్ మాత్రమే:
SMALLCAP_250 = [
    "AARTIDRUGS", "AAVAS", "AEGISCHEM", "AFFLE", "AJMERA", "AKZOINDIA", "ALEMBICLTD", "ALKYLAMINE", 
    "ALLCARGO", "AMARAJABAT", "AMBER", "ANANDTHI", "ANURAS", "APLLTD", "APTUS", "ASAHIINDIA", 
    ...
    "CITYUNION", "CLEAN", "COCHINPETRO", "COFFEEDAY", "CRAFTSMAN", "CREDITACC", "CSBBANK", "CYIENT", 
    ...
    "FDC", "FILATEX", "FINCABLES", "FINEORG", "FINPIPE", "FIRSTSOURCE", "FSL", "GABRIEL", 
    ...
    "HEIDELBERG", "HERITGFOOD", "HFCL", "HGS", "HIKAL", "HIL", "HIMATSEIDE", "HINDUJAVEN", 
    "HINDZINC", "HOMEFIRST", "HONAUT", "HSCL", "IBREALEST", "ICIL", "IDBI", "IDFC", 
    "IFBIND", "IIFL", "IL&FSENGG", "IL&FSTRANS", "INDOCO", "INDORAMA", "INFIBEAM", "INGERRAND", 
    ...
    "KRBL", "KSB", "KTKBANK", "LAOPALA", "LATENTVIEW", "LAXMIMACH", "LEMMATREE", "LINDEINDIA", 
    "LUXIND", "MAHABANK", "MAHINDCIE", "MAHLIFE", "MAHLOG", "MAHSCOOTER", "MAITHANALL", "MANALIPETC", 
    "MANINFRA", "MARKSANS", "MASFIN", "MASTEK", "MATRIMONY", "MAYURUNIQ", "MAZDA", "MFL", 
    "MHRIL", "MIDHANI", "MINDACORP", "MINDAIND", "MOLDTKPAC", "MONTECARLO", "MOREPENLAB", "MRPL", 
    ...
    "SFL", "SHALBY", "SHALPAINTS", "SHANKARACA", "SHARDACROP", "SHARDAMOTR", "SHILPAMED", "SHOPERSTOP", 
    ...
    "SUBROS", "SUDARSCHEM", "SUMICHEM", "SUNCLAYLTD", "SUNDARMHLD", "SUNFLAG", "SUNTECK", "SUPRAJIT", 
...
def fetch_all_data():
    ...
    # 🔥 యాహూ ఫైనాన్స్ కనెక్షన్ కట్ అవ్వకుండా 200 స్టాక్స్ ని ఒక బ్యాచ్ లాగా డౌన్‌లోడ్ చేస్తున్నాం
    chunk_size = 200
    data_frames = []
