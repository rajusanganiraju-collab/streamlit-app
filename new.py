...
st.markdown("""
    ...
    /* 🔥 Adjusted Top to match inline title styling 🔥 */
...
# 🔥 RENDER CHART (INSTITUTIONAL FIX: No Error, Thin Line, Single Price inline!) 🔥
def render_chart(row, df_chart, show_pin=True, key_suffix="", timeframe="Day", show_crosshair=False, show_vol=False):
    ...
    # 🔥 VWAP/EMA text completely removed. Price (White) & Pct (Color) on the same line as Stock Name! 🔥
    st.markdown(f"""
        ...
        if not df_chart.empty:
            ...
            if show_vol:
                ...
                fig.add_trace(go.Candlestick(
                    ...
                    increasing_line_color='#2ea043', decreasing_line_color='#da3633', showlegend=False, hoverinfo='none'
                ), row=1, col=1)
                ...
                if show_crosshair:
                    ...
                    fig.update_yaxes(showspikes=True, spikemode='across', spikesnap='cursor', spikethickness=1, spikedash='dot', spikecolor="#ffffff", showticklabels=True, side='right', tickfont=dict(color="#ffffff", size=10), showline=False, showgrid=False, zeroline=False, fixedrange=True, range=[min_val - y_padding, max_val + y_padding], row=1, col=1)
                    fig.update_xaxes(showspikes=False, showticklabels=False, showline=False, showgrid=False, zeroline=False, fixedrange=True, row=1, col=1)
                    ...
                    fig.update_yaxes(showticklabels=False, showline=False, showgrid=False, zeroline=False, fixedrange=True, range=[min_val - y_padding, max_val + y_padding], row=1, col=1)
                    fig.update_xaxes(showticklabels=False, showline=False, showgrid=False, zeroline=False, fixedrange=True, row=1, col=1)
                    fig.update_yaxes(visible=False, fixedrange=True, row=2, col=1)
                    fig.update_xaxes(visible=False, fixedrange=True, row=2, col=1)
                ...
                fig.add_trace(go.Candlestick(
                    x=df_chart.index, open=df_chart['Open'], high=df_chart['High'], low=df_chart['Low'], close=df_chart['Close'], 
                    increasing_line_color='#2ea043', decreasing_line_color='#da3633', hoverinfo='none'
                ))
                ...
                if show_crosshair:
                    fig.update_layout(hovermode='y', dragmode='crosshair')
                    fig.update_yaxes(showspikes=True, spikemode='across', spikesnap='cursor', spikethickness=1, spikedash='dot', spikecolor="#ffffff", showticklabels=True, side='right', tickfont=dict(color="#ffffff", size=10), showline=False, showgrid=False, zeroline=False, fixedrange=True, range=[min_val - y_padding, max_val + y_padding])
                    fig.update_xaxes(showspikes=False, showticklabels=False, showline=False, showgrid=False, zeroline=False, fixedrange=True)
                else:
                    fig.update_layout(hovermode=False, dragmode=False)
                    fig.update_yaxes(showticklabels=False, showline=False, showgrid=False, zeroline=False, fixedrange=True, range=[min_val - y_padding, max_val + y_padding])
                    fig.update_xaxes(showticklabels=False, showline=False, showgrid=False, zeroline=False, fixedrange=True)

            # 🔥 NO staticPlot. This was causing the error when hover tried to activate! 🔥
