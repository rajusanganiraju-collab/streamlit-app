...
SMALLCAP_250 = [
    ...
    "CUB", "CLEAN", "COCHINPETRO", "COFFEEDAY", "CRAFTSMAN", "CREDITACC", "CSBBANK", "CYIENT", 
    ...
    "SUBROS", "SUDARSCHEM", "SUMICHEM", "TVSHLDGS", "SUNDARMHLD", "SUNFLAG", "SUNTECK", "SUPRAJIT", 
    ...
    "TIMKEN", "TIPSINDLTD", "TNPL", "TOKYOPLAST", "TRITURBINE", "TRIVENI", "TTKPRESTIG", 
    ...
    "VTL", "WABAG", "WATERBASE", "WELCORP", "WELENT", "WELSPUNLIV", "WSTCSTPAPR", "XYLEM", 
